...
/*3000      */ typedef struct {
               UNSIGNED8      highestSubIndexSupported;
               BOOLEAN        rebootBoard;
               BOOLEAN        poweroffBoard;
               BOOLEAN        quit;
               BOOLEAN        CPUFrequency;
               }              OD_OLMControl_t;
/*3001      */ typedef struct {
               UNSIGNED8      highestSubIndexSupported;
               VISIBLE_STRING OSName[1];
               VISIBLE_STRING OSDistro[1];
               VISIBLE_STRING OSKernelVersion[1];
               VISIBLE_STRING hostname[1];
               UNSIGNED32     uptime;
               UNSIGNED8      numberOfCPUs;
               VISIBLE_STRING CPUArchitecture[1];
               UNSIGNED8      CPUGovernor;
               UNSIGNED16     CPUFrequency;
               UNSIGNED8      numberOfRemoteprocs;
               UNSIGNED8      remoteprocXSelector;
               VISIBLE_STRING remoteprocXName[1];
               VISIBLE_STRING remoteprocXState[1];
...
/*3002      */ typedef struct {
               ...
               VISIBLE_STRING filter[1];
               UNSIGNED32     cacheLen;
               UNSIGNED32     iterator;
               VISIBLE_STRING fileName[1];
               UNSIGNED32     fileSize;
               BOOLEAN        deleteFile;
               }              OD_fileCaches_t;
/*3003      */ typedef struct {
