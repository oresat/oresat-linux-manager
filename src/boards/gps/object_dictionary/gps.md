...
| File Version | 1                              |
| Created      | 3/9/2021 10:31:29 PM           |
| Created By   | Ryan Medick                    |
| Modified     | 11/26/2021 12:50:03 PM         |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of mapped application objects in PDO| UNSIGNED8  | rw  | no  | no   | 0x01          |
| 0x01 | Mapping object 1      | UNSIGNED32 | rw  | no  | no   | 0x60020140    |
| 0x02 | Mapping object 2      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x03 | Mapping object 3      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Mapping object 4      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Mapping object 5      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of mapped application objects in PDO| UNSIGNED8  | rw  | no  | no   | 0x02          |
| 0x01 | Mapping object 1      | UNSIGNED32 | rw  | no  | no   | 0x60020220    |
| 0x02 | Mapping object 2      | UNSIGNED32 | rw  | no  | no   | 0x60020320    |
| 0x03 | Mapping object 3      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Mapping object 4      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Mapping object 5      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Mapping object 6      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of mapped application objects in PDO| UNSIGNED8  | rw  | no  | no   | 0x02          |
| 0x01 | Mapping object 1      | UNSIGNED32 | rw  | no  | no   | 0x60020420    |
| 0x02 | Mapping object 2      | UNSIGNED32 | rw  | no  | no   | 0x60020520    |
| 0x03 | Mapping object 3      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Mapping object 4      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Mapping object 5      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Mapping object 6      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of mapped application objects in PDO| UNSIGNED8  | rw  | no  | no   | 0x02          |
| 0x01 | Mapping object 1      | UNSIGNED32 | rw  | no  | no   | 0x60020620    |
| 0x02 | Mapping object 2      | UNSIGNED32 | rw  | no  | no   | 0x60020720    |
| 0x03 | Mapping object 3      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Mapping object 4      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Mapping object 5      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Mapping object 6      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| 0x02 | Mapping object 2      | UNSIGNED32 | rw  | no  | no   | 0x60010008    |
| 0x03 | Mapping object 3      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Mapping object 4      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Mapping object 5      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Mapping object 6      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| 0x01 | Time stamp            | UNSIGNED64 | ro  | t   | no   | 0             |
| 0x02 | Position X            | INTEGER32  | ro  | t   | no   | 0             |
| 0x03 | Position Y            | INTEGER32  | ro  | t   | no   | 0             |
| 0x04 | Position Z            | INTEGER32  | ro  | t   | no   | 0             |
| 0x05 | Velocity X            | INTEGER32  | ro  | t   | no   | 0             |
| 0x06 | Velocity Y            | INTEGER32  | ro  | t   | no   | 0             |
| 0x07 | Velocity Z            | INTEGER32  | ro  | t   | no   | 0             |

### 0x6003 - Time synchronized
| Object Type | Count Label    | Storage Group  |
| ----------- | -------------- | -------------- |
| VAR         |                | RAM            |
