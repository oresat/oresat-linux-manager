...
|              |                                |
| ------------ | ------------------------------ |
| Project File | star_tracker.xdd               |
| File Version | 1                              |
| Created      | 3/9/2021 12:57:28 PM           |
| Created By   | Ryan Medick                    |
| Modified     | 11/26/2021 12:50:21 PM         |
...
| Transmission | type=254; inhibit-time=0; event-timer=1000; SYNC-start-value=0|
|   0x60000008 | Star tracker status                                           |
|   0x60010110 | Orienation (Right Ascension)                                  |
|   0x60010210 | Orienation (Declination)                                      |
|   0x60010310 | Orienation (Roll)                                             |
...
| Transmission | type=254; inhibit-time=0; event-timer=1000; SYNC-start-value=0|
|   0x60010440 | Orienation (Timestamp)                                        |
...
| Data Type               | SDO | PDO | SRDO | Default Value                   |
| ----------------------- | --- | --- | ---- | ------------------------------- |
| VISIBLE_STRING          | ro  | no  | no   | OreSat Node                     |
...
| Sub  | Name                  | Data Type  | SDO | PDO | SRDO | Default Value |
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of mapped application objects in PDO| UNSIGNED8  | rw  | no  | no   | 0x04          |
| 0x01 | Mapping object 1      | UNSIGNED32 | rw  | no  | no   | 0x60000008    |
| 0x02 | Mapping object 2      | UNSIGNED32 | rw  | no  | no   | 0x60010110    |
| 0x03 | Mapping object 3      | UNSIGNED32 | rw  | no  | no   | 0x60010210    |
| 0x04 | Mapping object 4      | UNSIGNED32 | rw  | no  | no   | 0x60010310    |
| 0x05 | Mapping object 5      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Mapping object 6      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x07 | Mapping object 7      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x08 | Mapping object 8      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Number of mapped application objects in PDO| UNSIGNED8  | rw  | no  | no   | 0x01          |
| 0x01 | Mapping object 1      | UNSIGNED32 | rw  | no  | no   | 0x60010440    |
| 0x02 | Mapping object 2      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x03 | Mapping object 3      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x04 | Mapping object 4      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Mapping object 5      | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x04          |
| 0x01 | Reboot Board          | BOOLEAN    | wo  | no  | no   | 0             |
| 0x02 | Poweroff Board        | BOOLEAN    | wo  | no  | no   | 0             |
| 0x03 | Quit                  | BOOLEAN    | wo  | no  | no   | 0             |
| 0x04 | CPU frequency         | BOOLEAN    | rw  | no  | no   | 0             |
...
| 0x01 | OS name               | VISIBLE_STRING| ro  | no  | no   | x             |
| 0x02 | OS distro             | VISIBLE_STRING| ro  | no  | no   | x             |
| 0x03 | OS kernel version     | VISIBLE_STRING| ro  | no  | no   | x             |
| 0x04 | hostname              | VISIBLE_STRING| ro  | no  | no   | x             |
| 0x05 | Uptime                | UNSIGNED32 | ro  | no  | no   | 0             |
| 0x06 | Number of CPUs        | UNSIGNED8  | ro  | no  | no   | 0             |
| 0x07 | CPU architecture      | VISIBLE_STRING| ro  | no  | no   | x             |
...
| 0x0C | RemoteprocX name      | VISIBLE_STRING| ro  | no  | no   | x             |
| 0x0D | RemoteprocX state     | VISIBLE_STRING| ro  | no  | no   | x             |
...
| 0x04 | Filter                | VISIBLE_STRING| rw  | no  | no   | x             |
| 0x05 | Cache len             | UNSIGNED32 | ro  | no  | no   | 0             |
| 0x06 | Iterator              | UNSIGNED32 | rw  | no  | no   | 0             |
| 0x07 | File name             | VISIBLE_STRING| ro  | no  | no   | x             |
| 0x08 | File size             | UNSIGNED32 | ro  | no  | no   | 0             |
| 0x09 | Delete file           | BOOLEAN    | wo  | no  | no   | 0             |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x04          |
| 0x01 | File name             | VISIBLE_STRING| rw  | no  | no   | x             |
| 0x02 | File data             | DOMAIN     | ro  | no  | no   |               |
| 0x03 | Reset                 | BOOLEAN    | wo  | no  | no   | 0             |
| 0x04 | Delete file           | BOOLEAN    | wo  | no  | no   | 0             |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x06          |
| 0x01 | Total apps            | UNSIGNED8  | ro  | t   | no   | 0             |
| 0x02 | Active apps           | UNSIGNED8  | ro  | t   | no   | 0             |
| 0x03 | Failed apps           | UNSIGNED8  | ro  | t   | no   | 0             |
| 0x04 | Select app            | UNSIGNED8  | rw  | no  | no   | 0             |
| 0x05 | App name              | VISIBLE_STRING| ro  | no  | no   | x             |
| 0x06 | Daemon state          | UNSIGNED8  | rw  | no  | no   | 0             |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x05          |
| 0x01 | Status                | UNSIGNED8  | ro  | t   | no   | 0xFF          |
| 0x02 | Updates available     | UNSIGNED8  | ro  | t   | no   | 0             |
| 0x03 | List updates          | VISIBLE_STRING| ro  | no  | no   | x             |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x04          |
| 0x01 | Right Ascension       | INTEGER16  | ro  | t   | no   | 0             |
| 0x02 | Declination           | INTEGER16  | ro  | t   | no   | 0             |
| 0x03 | Roll                  | INTEGER16  | ro  | t   | no   | 0             |
| 0x04 | Timestamp             | UNSIGNED64 | ro  | t   | no   | 0             |
...
| Data Type               | SDO | PDO | SRDO | Default Value                   |
| ----------------------- | --- | --- | ---- | ------------------------------- |
| UNSIGNED8               | wo  | no  | no   | 0xFF                            |

### 0x6004 - Get last solve image
| Object Type | Count Label    | Storage Group  |
| ----------- | -------------- | -------------- |
| VAR         |                | RAM            |
