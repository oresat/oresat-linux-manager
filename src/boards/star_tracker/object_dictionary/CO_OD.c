...
/*1000*/ 0x0000L,
/*1008*/ {'O', 'r', 'e', 'S', 'a', 't', ' ', 'S', 't', 'a', 'r', ' ', 'T', 'r', 'a', 'c', 'k', 'e', 'r'},
/*1009*/ {'0', '.', '0'},
/*100A*/ {'0', '.', '0', '.', '0'},
...
/*0x3000*/ const CO_OD_entryRecord_t OD_record3000[5] = {
           ...
           {(void*)&CO_OD_RAM.OLMControl.coreAsyncThreadDelay, 0x8E, 0x2 },
           {(void*)&CO_OD_RAM.OLMControl.appAsyncThreadDelay, 0x8E, 0x2 },
...
/*0x6001*/ const CO_OD_entryRecord_t OD_record6001[5] = {
           ...
           {(void*)&CO_OD_RAM.orienation.roll, 0xA2, 0x4 },
           {(void*)&CO_OD_RAM.orienation.timestamp, 0xA2, 0x4 },
};
...
{0x1008, 0x00, 0x05, 19, (void*)&CO_OD_ROM.manufacturerDeviceName},
