...
/*1A01*/ {0x1L, 0x60000008L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L, 0x0000L},
...
{0x6000, 0x00, 0x26,  1, (void*)&CO_OD_RAM.dxWiFiStatus},
};
// clang-format on
