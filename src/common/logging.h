...
#define LOG_DBUS_GET_PROPERTY_ERROR(log_lvl, app_name, prop_name, err_name) \
    log_printf(log_lvl, "app %s: dbus get property %s failed: %s", app_name, prop_name, err_name)

#define LOG_DBUS_SET_PROPERTY_ERROR(log_lvl, app_name, prop_name, err_name) \
    log_printf(log_lvl, "app %s: dbus set property %s failed: %s", app_name, prop_name, err_name)

#define LOG_DBUS_PROPERTY_READ_ERROR(log_lvl, app_name, prop_name, err_name) \
    log_printf(log_lvl, "app %s: dbus property %s read failed: %s", app_name, prop_name, err_name)

#define LOG_DBUS_CALL_METHOD_ERROR(log_lvl, app_name, signal_name, err_name) \
    log_printf(log_lvl, "app %s: dbus method %s call failed: %s", app_name, signal_name, err_name)

#define LOG_DBUS_METHOD_READ_ERROR(log_lvl, app_name, signal_name, err_name) \
    log_printf(log_lvl, "app %s: dbus method %s read failed: %s", app_name, signal_name, err_name)
